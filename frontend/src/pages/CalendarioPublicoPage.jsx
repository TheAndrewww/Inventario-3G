...
const CalendarioPublicoPage = () => {
  ...
  const [escala, setEscala] = useState(() => {
    const escalaGuardada = localStorage.getItem('calendarioPublicoEscala');
  ...
  useEffect(() => {
    localStorage.setItem('calendarioPublicoEscala', escala.toString());
  }, [escala]);
