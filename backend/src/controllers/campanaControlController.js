...
export const updateCell = async (req, res) => {
    try {
        ...
        const validAreas = ['ventas', 'ventas_dlba', 'ventas_vrj', 'diseno', 'manufactura', 'herreria', 'equipo1', 'equipo2', 'equipo3', 'equipo4', 'operacion', 'logistica', 'almacen', 'calidad'];
...
export const getTotals = async (req, res) => {
    try {
        ...
        const areas = ['ventas', 'ventas_dlba', 'ventas_vrj', 'diseno', 'manufactura', 'herreria', 'equipo1', 'equipo2', 'equipo3', 'equipo4', 'operacion', 'logistica', 'almacen', 'calidad'];
        areas.forEach(area => {
            totals.byArea[area] = {};
            for (let q = 1; q <= 4; q++) {
