...
/**
 * Verifica que el almacén exista. Las secciones aplican a todos los almacenes.
 */
const validarAlmacen = async (almacen_id) => {
    if (!almacen_id) {
...
export const crearSeccion = async (req, res) => {
    try {
        ...
        const valid = await validarAlmacen(almacen_id);
